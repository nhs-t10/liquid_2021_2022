...
public class GetTicksFunction extends NativeRobotFunction {
    ...
    public AutoautoPrimitive call(AutoautoPrimitive[] args) {
        if(args.length == 0) {return new AutoautoNumericValue}throw new org.firstinspires.ftc.teamcode.auxilary.dsls.autoauto.runtime.errors.AutoautoNoNativeMethodOverloadException("No getTicks with 0 args");
    }
}
 */